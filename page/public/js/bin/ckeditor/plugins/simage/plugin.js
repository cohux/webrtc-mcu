	...
	init: function( editor ) {
		editor.addCommand('simage', {
			exec: function (editor) {
				...
				a.onchange = function(){
					file = a.files[0];
					CKEDITOR.currentInstance.element.setAttribute("disabled", "disabled")
					...
					if (file.size > 5000000){
						...
						CKEDITOR.instances[curr.name].element.setAttribute("disabled", "disabled")
						return
					...
					axios.post(editor.config.imageUploadURL, formData, {
